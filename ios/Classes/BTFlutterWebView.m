...
#import "BTFlutterWebView_Test.h"
#import "BTJavaScriptChannelHandler.h"

@implementation BTWebViewFactory {
  NSObject<FlutterBinaryMessenger> *_messenger;
  BTCookieManager *_cookieManager;
}
...
- (instancetype)initWithFrame:(CGRect)frame
  ...
  if (self = [super init]) {
    ...
    NSString *channelName = [NSString stringWithFormat:@"bootpay.co.kr/webview_%lld", viewId];
    ...
    _webView = [[BTWKWebView alloc] initWithFrame:frame configuration:configuration];
...
- (void)onLoadFile:(FlutterMethodCall *)call result:(FlutterResult)result {
  NSString *error = nil;
  if (![BTWebViewController isValidStringArgument:[call arguments] withErrorMessage:&error]) {
...
- (void)onLoadHtmlString:(FlutterMethodCall *)call result:(FlutterResult)result {
  ...
  NSString *error = nil;
  if (![BTWebViewController isValidStringArgument:htmlString withErrorMessage:&error]) {
