...
+ (BTCookieManager *)instance {
  static BTCookieManager *instance = nil;
  if (instance == nil) {
    instance = [[BTCookieManager alloc] init];
  }
  return instance;
}
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar> *)registrar {
  FlutterMethodChannel *channel =
      [FlutterMethodChannel methodChannelWithName:@"bootpay.co.kr/cookie_manager"
