...
@interface BTUserContentControllerHostApiTests : XCTestCase
@end

@implementation BTUserContentControllerHostApiTests
- (void)testCreateFromWebViewConfigurationWithIdentifier {
  BTInstanceManager *instanceManager = [[BTInstanceManager alloc] init];
  BTUserContentControllerHostApiImpl *hostAPI =
                                    ...
                                    userScript:
                                        [BTWKUserScriptData
                                             makeWithSource:@"runAScript"
                                              injectionTime:
                                                  [BTWKUserScriptInjectionTimeEnumData
                                                      makeWithValue:
                                                          BTWKUserScriptInjectionTimeEnumAtDocumentEnd]
                                            isMainFrameOnly:@YES]
                                         error:&error];
