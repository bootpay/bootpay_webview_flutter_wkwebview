...
#ifndef BOOTPAY_WEBVIEW_FLUTTER_WKWEBVIEW_SWIFT_H
#define BOOTPAY_WEBVIEW_FLUTTER_WKWEBVIEW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="bootpay_webview_flutter_wkwebview",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC33bootpay_webview_flutter_wkwebview22BTWebViewFlutterPlugin")
...
SWIFT_CLASS("_TtC33bootpay_webview_flutter_wkwebview22NavigationDelegateImpl")
